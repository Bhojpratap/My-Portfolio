# Bhojpratap Sahu - Personal Portfolio
...
1. Clone the repository:
   ```bash
   git clone https://github.com/Bhojpratap/My-Portfolio.git
   cd My-Portfolio
   ```
...
Contributions, issues, and feature requests are welcome! Feel free to check the [issues page](https://github.com/Bhojpratap/My-Portfolio.git).
