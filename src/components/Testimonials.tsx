...
const TESTIMONIALS = [
  {
    quote: "Sanju delivered exceptional code on the AutomateBox project. His understanding of modern web development practices and attention to detail were outstanding.",
    name: "Aaysh Agrawal",
    role: "Founder & CEO, DeveloperBox",
    initials: "AA",
  },
  {
    quote: "Working with Sanju with his UI development skills was a game-changer for our project. He brought our designs to life with pixel-perfect precision and smooth animations.",
    name: "Anshu Agrawal",
    role: "Founder & CEO, Evdt",
    initials: "AA",
  },
  {
