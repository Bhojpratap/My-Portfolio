        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-start">
          ...
          >
            ...
            <div className="flex flex-col gap-6 mb-12">
              <a href="mailto:bhojpratap.com@gmail.com
" className="flex items-center gap-4 text-gray-300 hover:text-white transition-colors group">
                ...
                <span className="text-lg">bhojpratap.com@gmail.com
</span>
              </a>
              
              <div className="flex items-center gap-4">
                 <SocialLink href="https://github.com/Bhojpratap" icon={<GithubIcon />} label="GitHub" />
                 <SocialLink href="https://www.linkedin.com/in/bhojpratap-sahu-22qq22/" icon={<LinkedinIcon />} label="LinkedIn" />
                 <SocialLink href="https://twitter.com/" icon={<TwitterIcon />} label="Twitter" />
              </div>
            </div>

            <a 
              href="/Bhojpratap Sahu Software Developer Resume.pdf" 
              download 
        ...
        <footer className="mt-24 pt-8 border-t border-white/5 text-center text-gray-500 font-mono text-sm">
           <p>&copy; {new Date().getFullYear()} Bhojpratap Sahu. All rights reserved.</p>
        </footer>
      </div>
    </section>
  );
