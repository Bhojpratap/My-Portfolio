...
const TIMELINE_DATA = [
  {
    ...
    description: "Architecting enterprise-scale applications. Expertise in Next.js, UI design and development, and Cloud Architecture.",
    type: "work",
  },
  {
    year: "2021 - 2023",
    ...
    description: "Discovered a passion for problem-solving. Dedicated hours to mastering the MERN stack and software engineering fundamentals.",
    type: "milestone",
  },
  {
    year: "2022 - 2026",
    ...
    description: "Developed a strong analytical mindset and understanding of Software Engineering principles.",
    type: "education",
  },
  // {
  //   year: "2018 - 2020",
      ...
      <div className="max-w-7xl mx-auto relative z-10">
        ...
        >
          ...
          <p className="text-gray-400 text-lg max-w-2xl mx-auto leading-relaxed">
            From writing my first Box render to building complex UI and Software applications. 
