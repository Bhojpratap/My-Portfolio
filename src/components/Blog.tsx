...
const ARTICLES = [
  {
    ...
    excerpt: "How I pivoted from a Science to Full Stack Development. The challenges, the late nights, and the breakthroughs.",
    category: "Journey",
    readTime: "5 min read",
  ...
  {
    title: "Understanding UI Architecture",
    excerpt: "A deep dive into how I built the multiple projects with a focus on clean, scalable UI components.",
    category: "Tech",
    readTime: "8 min read",
  ...
  {
    title: "Why I picked Software Development",
    excerpt: "My intrest on designing mordern UI and building softwares that solve real-world problems.",
    category: "Tech",
    readTime: "6 min read",
