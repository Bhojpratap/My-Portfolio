...
const projects = [
  {
    id: "TheStmartFellowship",
    title: "The Stmart Fellowship",
    category: "Frontend",
    description: "Offline workplace simulation mastering essential soft, behavioral & cognitive skills for entry-level jobs.",
    longDescription: "The Smart Fellowship is an offline workplace simulation where smart fellows master essential soft skills, behavioral skills and cognitive skills which are now ‘must haves’ for entry level jobs across sectors and domains.",
    techStack: ["Next.js", "TypeScript", "Tailwind CSS"],
    repo: "https://github.com/Bhojpratap",
    demo: "#",
    color: "from-blue-600/20 to-white-500/20",
    hoverColor: "group-hover:from-orange-600/40 group-hover:to-white-500/40",
    span: "md:col-span-2 md:row-span-2",
    mediaType: "image",
    // Abstract Network/Server for Grid
    mediaUrl: "/image/1 (1).png",
    // Code/Structure Demo for Modal
    demoUrl: "/image/1 (2).png"
  },
  {
    id: "SurveyApp",
    title: "Survey App",
    category: "FullStack",
    description: "Survey platform with user authentication, dynamic forms, and real-time analytics.",
    longDescription: "A Full-Stack survey application built with Next.js and MongoDB. Features user authentication, dynamic form creation, and real-time analytics dashboard for survey results.",
    techStack: ["React", "TypeScript", "Material UI", "MongoDB", "Express", "Node.js"],
     repo: "https://github.com/Bhojpratap",

    demo: "#",
    color: "from-white-600/20 to-white-500/20",
    hoverColor: "group-hover:from-white-600/40 group-hover:to-white-500/40",
    span: "md:col-span-1 md:row-span-2",
    mediaType: "image",
    // Shopping/Ecommerce Concept
    mediaUrl: "/image/7 (2).png",
    // Shopping Interaction
    demoUrl: "/image/7 (1).png"
  },
  {
    id: "AutomateBox ",
    title: "AutomateBox ",
    category: "Frontend",
    description: "AutomateBox is a flexible base software built to simplify management system development.",
    longDescription: "AutomateBox is a flexible base software built to simplify management system development. It helps create CRM, HRM, Fleet, Real Estate, and other business applications faster.",
    techStack: ["React", "TypeScript", "React Bootstrap", "Metronic theme"],
       repo: "https://github.com/Bhojpratap",

    demo: "https://developerbox.co.in/products/",
    color: "from-orange-500/20 to-red-500/20",
    hoverColor: "group-hover:from-white-500/40 group-hover:to-white-500/40",
    span: "md:col-span-1 md:row-span-1",
    mediaType: "image",
    // Cloud/Data Abstract
    mediaUrl: "/image/8 (1).png",
    // File Management
    demoUrl: "/image/8 (2).png"
  },
  {
    id: "PKSquare",
    title: "PK Square",
    category: "MERN Stack",
    description: "Realstate listing platform with user authentication, property management, and search functionality.",
    longDescription: "PK Square is a real estate listing platform built with the MERN stack. It features user authentication, property management, and search functionality for buyers seller and builders.",
    techStack: ["Next.js", "TypeScript", "MongoDB", "Express", "Node.js"],
       repo: "https://github.com/Bhojpratap",

    demo: "https://www.pksquare.in/",
    color: "from-white-600/20 to-white-500/20",
    hoverColor: "group-hover:from-white-600/40 group-hover:to-white-500/40",
    span: "md:col-span-1 md:row-span-1",
    mediaType: "image",
    // Reading/Books
    mediaUrl: "/image/5 (1).png",
    // Library/Shelf
    demoUrl: "/image/5 (2).png"
  },
  {
    id: "ChhattisgarhHerbals ",
    title: "Chhattisgarh Herbals ",
    category: "Frontend",
    description: "Chhattisgarh Herbals is a premium product brand that works towards empowering tribal women.",
    longDescription: "eCommerce platform for Chhattisgarh Herbals, a premium product brand that works towards empowering tribal women through sustainable and ethical practices.",
    techStack: ["React", "React Bootstrap"],
    repo: "https://github.com/Bhojpratap",


    demo: "https://www.chhattisgarhherbal.com/",
    color: "from-green-600/20 to-teal-500/20",
    hoverColor: "group-hover:from-white-600/40 group-hover:to-white-500/40",
    span: "md:col-span-1 md:row-span-1",
    mediaType: "image",
    // Typing/Code Abstract
    mediaUrl: "/image/4 (2).png",
    // Server/Terminal
    demoUrl: "/image/4 (1).png"
  },
  
   {
    ...
    title: "Cogmentor",
    category: "Frontend",
    description: "Cogmentor is India's first cognitive assessment platform that provides training towards the development of children's cognitive functioning.",
    longDescription: " Cogmentor is India's first cognitive assessment platform that provides training towards the development of children's cognitive functioning. It offers a range of interactive exercises and activities designed to enhance cognitive skills such as memory, attention, problem-solving, and critical thinking.",
    techStack: ["React", "Reactstrap"],
    repo: "https://github.com/Bhojpratap",

    demo: "https://beta.cogmentor.com/",
    color: "from-white-600/20 to-white-500/20",
    hoverColor: "group-hover:from-white-600/40 group-hover:to-white-500/40",
    span: "md:col-span-2 md:row-span-2",
    mediaType: "image",
    // Color/Art
    mediaUrl: "/image/2 (2).png",
    // Searching/Scanning
    demoUrl: "/image/2 (1).png"
  },
 
   {
    ...
    title: "Paridhi Group",
    category: "Frontend",
    description: "Real estate consultant in Raipur, Chhattisgarh",
    longDescription: "A real estate consultant based in Raipur, Chhattisgarh, offering comprehensive services for buying, selling, and renting properties. With a deep understanding of the local market.",
    ...
    mediaType: "image",
    // Color/Art
    mediaUrl: "/image/3 (2).png",
    // Searching/Scanning
    demoUrl: "/image/3 (2).png"
  },
];
      ...
      <div className="max-w-7xl mx-auto relative">
        ...
        >
          ...
          <p className="text-gray-400 text-lg max-w-2xl leading-relaxed">
             A selection of projects demonstrating full-stack capabilities and modern interface design.
          </p>
        </motion.div>
